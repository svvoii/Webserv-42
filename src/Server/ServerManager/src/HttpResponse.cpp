...
std::string		HttpResponse::getResponse() {
	...
	enum Methods	method = _httpRequest->isMethod(_httpRequest->getMethod());
...
void	HttpResponse::_GetDefaultPath(std::ostringstream& responseStream) {
	...
	std::string body = _getFileContent("/mnt/nfs/homes/rokupin/Documents/myporects/Webserv-42/resources/default/www/root_index.html");
